...
<div class="row">
    <div class="col-12">
      <div class="card">
        ...
        <div class="card-body">
            {!! Form::open(['action' => ['App\Http\Controllers\Admin\BrandsController@update',$brand->id], 'method' => 'POST', 'enctype' => 'multipart/form-data']) !!}
                ...
                <div class="form-group row mb-4">
                    ...
                    <div class="col-sm-12 col-md-7">
                        {{ Form::url('url',$brand->brand_url,['class' => 'form-control','placeholder' => 'Brand URL']) }}
                    </div>
                </div>
