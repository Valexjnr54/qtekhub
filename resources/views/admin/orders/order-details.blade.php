            ...
            <table class="table table-striped" id="table-1">
              ...
              <tbody>
                ...
                <tr>
                    ...
                    @php
                        $customer = DB::select('select * from customers where id = ?', [$userDetail->customer_id]);
                    @endphp
                  ...
                  <td>
                    <a href="{{ route('admin.order',['id'=> $userDetail->customer_id ,'reference'=> $userDetail->reference ]) }}" class="btn btn-info">View Order</a>
